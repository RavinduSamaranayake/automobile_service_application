      ...
      <View style={styles.container}>
          ...
          <View style={styles.body}>
            <View style={styles.bodyContent}>
              ...
              <Text style={{color: 'white',fontWeight: 'bold' ,fontSize:18}}>Change Profile</Text>
              </TouchableOpacity>
              ...
              <Text style={{color: 'brown',fontWeight: 'bold'}}>Sign Out</Text>
               ...
               <Text style={{color: 'brown',fontWeight: 'bold', fontSize:18} } onPress={this.settingAccount}>Sign Out</Text>
            </View>
        </View>
      </View>
    );
