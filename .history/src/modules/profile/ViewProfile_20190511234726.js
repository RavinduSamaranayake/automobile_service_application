  ...
  async loadData() { //when we using componentWillMount first execte the function and then rendering the component
    ...
    try {
      ...
      if (value !== null) {
       ...
       this.setState({
         name: JSON.parse(this.state.userdata).name,
         email: JSON.parse(this.state.userdata).name,
         address: JSON.parse(this.state.userdata).name,
         nic: JSON.parse(this.state.userdata).name,
         contact: JSON.parse(this.state.userdata).name,
       });
       console.log('..............user state name value is......',this.state.name,'..................');
      } else {
        this.setState({
