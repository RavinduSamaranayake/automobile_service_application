...
export default class Booking extends Component {
 ...
 //click the list event and get the vehicle id
  ...
  setServiceModalVisible(item , visible) {
   ...
   // when click the service button visible the repair modal
   serviceModalVisible(item , visible) {
    this.setState({userSelected: item,
                   serviceModalVisible: visible
                  });
  } 
      ...
      <View style={styles.container}>
       ...
       {/* .............modal for repair............ */}
        ...
        <Modal
          animationType={'fade'}
          transparent={true}
          onRequestClose={() => this.setRepairModalVisible(this.state.userSelected,false)}
          ...
          <View style={styles.popupOverlay}>
            <View style={styles.popup}>
              ...
              <View style={styles.popupButtons}>
                ...
                <TouchableOpacity style={styles.followButton} onPress={()=> {this.setRepairModalVisible(false) }}>
       ...
       {/* .............modal for services............ */}
        <Modal
          animationType={'fade'}
          transparent={true}
          onRequestClose={() => this.setServiceModalVisible(this.state.userSelected,false)}
