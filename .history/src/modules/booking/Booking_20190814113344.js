...
// when click the repair button visible the repair modal and get the vehicle id
 ...
 confirmService(){
  const Service = {
    ...
    service_type:this.state.temp_service,
    date:this.state.service_date,
    arrival_time:this.state.arrival_time,
    additional_notes:this.state.serve_additional_notes
  }
  ...
  axios.post('api/appointments/book-service',Service)
      .then(res=>{
        this.setState({
          ...
          temp_service:[],
          service_date:'',
          serve_additional_notes:'',
          visible:true,
          serve_msg:res.data.msg,
          description:'You have been recieve a new service request from '+this.state.customer_name
        })
      })
