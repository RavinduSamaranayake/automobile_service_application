  ...
  render() {
      return (
        <View>
          ...
          <TextInput  style={styles.input}   ref="number" onChangeText={(contact) => this.setState({contact})} value={this.state.contact} />
          <TextInput  style={styles.input}  ref="idnum" onChangeText={(nic) => this.setState({date})} value={this.state.date} />
