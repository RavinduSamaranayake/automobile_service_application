  ...
  render() {
      return (
        <View>
          ...
          <TextInput  style={styles.input}  ref="username" onChangeText={(name) => this.setState({username})} value={this.state.username} />
          <TextInput  style={styles.input}   ref="email" onChangeText={(email) => this.setState({email})} value={this.state.email} />
          <TextInput  style={styles.input}  ref="address" onChangeText={(name) => this.setState({address})} value={this.state.address} />
