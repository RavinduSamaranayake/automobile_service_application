...
import {View,ScrollView, KeyboardText, TextInput,Alert, TouchableHighlight,  TouchableOpacity, StyleSheet, ImageBackground} from 'react-native';
  ...
  render() {
      return (
        ...
        <ScrollView> 
          ...
          <KeyboardSpacer/>        {/* The view that will animate to match the keyboards height */}
        </ScrollView>
