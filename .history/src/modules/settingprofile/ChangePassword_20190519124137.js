    ...
    if (this.state.isSave) {
      ...
      return (
        ...
        <KeyboardAwareScrollView> 
          ...
          <TextInput  style={styles.input}  secureTextEntry={true}  ref="password"  onChangeText={(name) => this.setState({name})} value={this.state.name} />
          <Text style={styles.textst}>Confirm Password</Text> 
          <TextInput  style={styles.input} secureTextEntry={true} ref="username" onChangeText={(username) => this.setState({username})} value={this.state.username} />
